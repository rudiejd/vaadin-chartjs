 ...
 *
 * <p>The data points should be a number, Chart.js will total all of the numbers and calculate the
 * relative proportion of each.
 *
 * <p>You can also add an array of background colors.
 *
 * <p>The color attributes should be a string. Similar to CSS, for this string you can use HEX
