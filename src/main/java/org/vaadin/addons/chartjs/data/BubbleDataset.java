 ...
 *
 * <p>The location of the bubble is determined by the first two dimensions and the corresponding
 * horizontal and vertical axes.
 *
 * <p>The third dimension is represented by the size of the individual bubbles.
 *
