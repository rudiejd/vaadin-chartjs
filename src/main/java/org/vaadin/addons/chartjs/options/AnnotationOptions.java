...
import org.vaadin.addons.chartjs.options.annotation.BoxAnnotation;
import org.vaadin.addons.chartjs.options.annotation.DrawTime;
import org.vaadin.addons.chartjs.options.annotation.LineAnnotation;
...
public class AnnotationOptions<T> extends And<T> implements JsonBuilder {
  ...
  // /**
  // * Mouse events to enable on each annotation. Should be an array of one or more
  // browser-supported mouse events
  // */
  ...
  /**
   * Double-click speed in ms used to distinguish single-clicks from double-clicks whenever you need
   * to capture both.
   *
   * <p>When listening for both click and dblclick, click events will be delayed by this amount.
   *
   * <p>Defaults to 350ms
   */
