...
/**
 * The radial linear scale is used specifically for the radar and polar are chart types. It overlays
 * the chart area, rather than being positioned on one of the edges.
 *
