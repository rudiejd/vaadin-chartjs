...
public class LineLabel<T> extends And<LineAnnotation<T>> implements JsonBuilder, Serializable {
  ...
  /**
   * Adjustment along x-axis (left-right) of label relative to above number (can be negative) For
   * horizontal lines positioned left or right, negative values move the label toward the edge, and
   * positive values toward the center. Defaults to 0.
   */
  ...
  /**
   * Adjustment along y-axis (top-bottom) of label relative to above number (can be negative). For
   * vertical lines positioned top or bottom, negative values move the label toward the edge, and
   * positive values toward the center. Defaults to 0.
   */
