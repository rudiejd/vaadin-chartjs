...
public class Zoom<T> extends And<T> implements JsonBuilder, Serializable {
  ...
  /**
   * Minimum range limits for zoom. Range currently supports Double and String values. Usage depends
  ...
  /**
   * Maximum range limits for zoom. Range currently supports Double and String values. Usage depends
   * on the datatypes in your scales.
   */
